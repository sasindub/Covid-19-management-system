 ...
 * @author sasin
 */
public class DeathPersons extends javax.swing.JFrame {

    /**
     * Creates new form DeathPersons
     */
     Connection con;
    Statement st;
    public DeathPersons() {
    ...
    public void getData() {
        ...
        try {
           ...
           vaccinedPData.affected();
            //create statement
            st = con.createStatement();

            //count Deaths
            String query1 = "select count(id) from deathpersons;";
            ...
            if (rs1.next()) {
                ...
                vaccinedPData.count();
                double avg = (rs1.getInt("count(id)") / (vaccinedPData.AFCOUNT * 1.0)) * 100.0;
            ...
            String query = "select * from deathpersons;";
            ...
            while (rs.next()) {
                ...
                String report = rs.getString("reportNo");
                String day = rs.getString("day");
             
                
                String tbData[] = {name,nic,report,day};
    ...
    private void initComponents() {
        ...
        lblAVGADeaths = new javax.swing.JLabel();
        ...
        tblVaccinedPerson.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "NIC", "Death Report No", "Issued Date"
            }
        ) {
        ...
        jLabel16.setText("COVID 19 DEATHS");
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 290, 60));

        jLabel2.setBackground(new java.awt.Color(4, 170, 109));
        jLabel2.setOpaque(true);
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(281, 29, 540, 23));
        ...
        jPanel1.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 440, 100, 30));
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 440, 100, 30));
        ...
        lbltotalDeaths.setBackground(new java.awt.Color(153, 153, 153));
        lbltotalDeaths.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        lbltotalDeaths.setForeground(new java.awt.Color(255, 102, 102));
        lbltotalDeaths.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lbltotalDeaths.setText("TOTAL DEATHS : ");
        jPanel1.add(lbltotalDeaths, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 80, 330, -1));

        lblAVGADeaths.setBackground(new java.awt.Color(153, 153, 153));
        lblAVGADeaths.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        lblAVGADeaths.setForeground(new java.awt.Color(255, 102, 102));
        lblAVGADeaths.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblAVGADeaths.setText("AVARAGE OF DEATHS : ");
        jPanel1.add(lblAVGADeaths, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 100, 320, -1));
        ...
        jPanel1.add(btnMoreDetails, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 440, 100, 30));
    ...
    private void btnReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReportActionPerformed
        ...
        //file saving path
        File file = new File("Covid19Deaths.txt");

        try{
            //make a new file
            FileWriter fw = new FileWriter(file);
            BufferedWriter bw = new BufferedWriter(fw);
            fw.write("\t\t---Covid 19 Death List----");
            fw.write("\n\n");

            fw.write("\t\tNAME   \t|   NIC   |\t   DEATH REPORT NO \t| ISSUED DATE\n");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try {
            ...
            String query = "select * from deathpersons where nic like '" + search + "%';";

            ResultSet rs = st.executeQuery(query);

            while (rs.next()) {
                tblVaccinedPerson.setModel(new DefaultTableModel(null,new String [] {"Name","NIC","Death Report No","Issued Day"}));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeathPersons.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeathPersons().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblAVGADeaths;
